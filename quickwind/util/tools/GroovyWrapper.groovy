...
def GROOVY_USER_LIB = new File( System.getProperty('user.home') + System.getProperty('file.separator') + ".groovy" + System.getProperty('file.separator') + "lib")
...
ant.jar( destfile: destFile, compress: true, index: true ) {
  ...
  if(GROOVY_USER_LIB.canRead()) {
    zipgroupfileset( dir: GROOVY_USER_LIB, includes: '*.jar' )
  }
  // add more jars here
